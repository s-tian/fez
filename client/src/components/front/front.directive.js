(function () {
    ...
    // ----- ControllerFunction -----
    ControllerFunction.$inject = ['logger', 'dataService'];

    /* @ngInject */
    function ControllerFunction(logger, dataService) {
        ...
        vm.animate_movie_title = function(index) {
            ...
            anime.timeline({complete: function(anim) {vm.animate_movie_title((index+1) % vm.popular_movie_list.length)}})
          .add({
            targets: '.ml11 .line',
            scaleY: [0,1],
            opacity: [0.5,1],
